			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							<!--PAGE CONTENT BEGINS-->
							<form class="form-inline" method="get" action="<%=request.getContextPath() %>/learn/classes">
								...
								<button  type="button" onclick="location.href='<%=request.getContextPath() %>/learn/addclassespage'" class="btn btn-purple btn-small">
									添加班级
